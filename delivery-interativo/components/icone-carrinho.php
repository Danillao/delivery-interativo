<!--ICONE CARRINHO COM QUANTIDADE DE PRODUTOS-->
<a class="text-dark" href="#popup1">
  <div class="d-flex carrinho">
    <big><span class="fad fa-shopping-cart">
        <small><small><small>
              <span class="position-absolute top-3 start-90 translate-middle badge rounded-pill bg-danger" style="bottom: 10px; left:18px;">
...
<!--POP-UP CHAMADO PELO ICONE DO CARRINHO-->
  ...
  <div class="popup">
    ...
    <div class="conteudo-popup">
      ...
      <div class="" align="center">
        <i class="far fa-shopping-cart text-primary"></i><a href='carrinho' class="text-primary" style="text-decoration: none"> Ver Carrinho</a>
      </div>
