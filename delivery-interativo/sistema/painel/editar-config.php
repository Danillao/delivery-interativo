...
$query = $pdo->query("SELECT * FROM tb_config");
...
//SCRIPT PARA SUBIR FOTO LOGO NO SERVIDOR
...
//VALIDAR TROCA DA FAVICON favicon.png
$query = $pdo->query("SELECT * FROM tb_config");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_reg = @count($res);
if ($total_reg > 0) {
...
//SCRIPT PARA SUBIR FOTO FAVICON NO SERVIDOR
...
//VALIDAR TROCA DA FOTO DO RELATORIO logo_rel.jpg
$query = $pdo->query("SELECT * FROM tb_config");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_reg = @count($res);
if ($total_reg > 0) {
...
//SCRIPT PARA SUBIR FOTO DA LOGO RELATORIO NO SERVIDOR
