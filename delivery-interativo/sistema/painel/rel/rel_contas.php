...
<body>
  ...
  <div class="mx-2">
    ...
    $query = $pdo->query("SELECT * from $tabela_consulta where ($busca >= '$dataInicial' and $busca <= '$dataFinal') and pago LIKE '$pago' order by id desc ");
