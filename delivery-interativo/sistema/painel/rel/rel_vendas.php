...
<body>
  ...
  <div class="mx-2">
    ...
    $query = $pdo->query("SELECT * from tb_vendas where (data >= '$dataInicial' and data <= '$dataFinal') and pago = 'Sim' and status LIKE '$status' and tipo_pgto LIKE '$forma_pgto' order by data asc, hora asc ");
