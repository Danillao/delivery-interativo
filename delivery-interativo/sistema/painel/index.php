...
$query = $pdo->query("SELECT * FROM tb_usuarios WHERE id = '$id_usuario'");
...
<head>
  ...
  <link rel="shortcut icon" href="../../img/<?= $favicon_sistema ?>" type="image/x-icon">
...
<body class="cbp-spmenu-push">
  <div class="main-content">
      ...
      <aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
        <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.php"><span class="fad fa-hat-chef"></span> Delivery<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="index.php">
                  <i class="fad fa-home icon"></i> <span>Home</span>
                </a>
              </li>

              <li class="treeview">
                <a href="index.php?pagina=pedidos">
                  <i class="fad fa-motorcycle icon"></i> <span>Pedidos</span>
                </a>
              </li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="index.php?pagina=bairros"><i class="fa fa-angle-right"></i> Bairros / Localidades</a></li>
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fad fa-utensils-alt icon"></i>
                  <span>Produtos</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  ...
                  <li><a href="index.php?pagina=saidas"><i class="fa fa-angle-right"></i> Saidas</a></li>
                </ul>
              </li>
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fad fa-money-check-edit-alt icon"></i>
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fad fa-file-chart-line icon"></i>
      ...
      <div class="header-left">
        ...
        <div class="profile_details_left">
          ...
          <ul class="nofitications-dropdown">
            <?php
            $query = $pdo->query("SELECT * FROM tb_vendas where data = '$data_atual' and status = 'Iniciado'");
            $res = $query->fetchAll(PDO::FETCH_ASSOC);
            $total_reg = @count($res);
            if ($total_reg > 1) {
            ...
            <li class="dropdown head-dpdn">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fad fa-utensils" style="color:#FFF"></i><span class="badge"><?php echo $total_reg ?></span></a>
              ...
              <ul class="dropdown-menu">
                ...
                <?php
                $query = $pdo->query("SELECT * FROM tb_vendas where data = '$data_atual' and status = 'Iniciado' order by id desc limit 6");
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
                $total_reg = @count($res);
                for ($i = 0; $i < $total_reg; $i++) {
                  ...
                  $query2 = $pdo->query("SELECT * FROM tb_clientes where id = '$cliente'");
    ...
    <!-- DIV PARA LISTAGEM DINAMICA DE PAGINAS-->
    <div id="page-wrapper">
      <?php
...
<!--SCRIPT PARA CARREGAR FOTO NA MODAL PERFIL-->
<script type="text/javascript">
...
<!--SCRIPT PARA CARREGAR FOTO DA LOGO NA MODAL CONFIG-->
<script type="text/javascript">
...
<!--SCRIPT PARA CARREGAR FOTO DA LOGO DO RELATORIO NA MODAL CONFIG-->
<script type="text/javascript">
...
<!--SCRIPT PARA CARREGAR FOTO DO ICONE NA MODAL CONFIG-->
<script type="text/javascript">
...
<!--SCRIPT PARA SUBMETER DADOS DA MODAL PERFIL PARA editar-perfil.php-->
<script type="text/javascript">
...
<!--SCRIPT PARA SUBMETER DADOS DA MODAL CONFIG PARA editar-config.php-->
<script type="text/javascript">
