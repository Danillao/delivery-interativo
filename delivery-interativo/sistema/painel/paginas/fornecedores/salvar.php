...
if ($id == "") {
  $query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, telefone = :telefone, endereco = :endereco, email = :email, data = '$data_atual', tipo_chave = '$tipo_chave', chave_pix = :chave_pix");
} else {
