...
<td>
	...
	<li class="dropdown head-dpdn2" style="display: inline-block;">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><big><i class="fad fa-trash-alt text-danger"></i></big></a>
	...
	<big><a href="#" onclick="ativar('{$id}', '{$acao}')" title="{$titulo_link}"><i class="{$icone} text-success"></i></a></big>

	<big><a href="#" onclick="saida('{$id}','{$nome}', '{$estoque}')" title="Saída de Produto"><i class="fad fa-arrow-from-top text-danger"></i></a></big>

	<big><a href="#" onclick="entrada('{$id}','{$nome}', '{$estoque}')" title="Entrada de Produto"><i class="fad fa-arrow-to-top text-verde"></i></a></big>

	<a href="#" onclick="variacoes('{$id}','{$nome}')" title="Variações do Produto"><i class="fad fa-random text-cinza"></i></a>

	<a href="#" onclick="ingredientes('{$id}','{$nome}')" title="Ingredientes do Produto"><i class="fad fa-list-ul text-primary"></i></a>

	<a href="#" onclick="adicionais('{$id}','{$nome}')" title="Adicionais do Produto"><i class="fad fa-plus text-verde"></i></a>
</td>
</tr>
HTML;
  }
