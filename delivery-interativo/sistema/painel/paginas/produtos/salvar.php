...
//FORMATANDO URL BASEADO NO NOME DO PRODUTO
...
if ($id == "") {
  $query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, categoria = '$categoria', valor_compra = :valor_compra, valor_venda = :valor_venda, descricao = :descricao, estoque = $estoque, foto = '$foto', nivel_estoque = '$nivel_estoque', tem_estoque = '$tem_estoque', ativo = 'Sim', url = '$url'");
} else {
