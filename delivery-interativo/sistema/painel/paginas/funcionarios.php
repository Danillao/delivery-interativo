...
$pag = 'funcionarios';
?>
<a class="btn btn-primary" onclick="inserir()" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Funcionario</a>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Email</label>
                <input maxlength="50" type="email" class="form-control" name="email" id="email" required>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control sel2" id="cargo" name="cargo" style="width:100%;">
                  ...
                  <?php
                  $query = $pdo->query("SELECT * FROM tb_cargos ORDER BY nome asc");
...
<!--SCRIPT QUE PEGA PAGINA ATUAL E CHAMA AJAX-->
...
<!--SCRIPT PARA CARREGAR IMAGEM NA MODAL-->
<script type="text/javascript">
