...
<td>	
      ...
      <a title="Cancelar Venda" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><big><i class="fad fa-trash-alt text-danger"></i></big></a>

      <ul class="dropdown-menu" style="margin-left:-230px;">
      <li>
      <div class="notification_desc2">
      <p>Cancelar Venda? <a href="#" onclick="excluir('{$id}')"><span class="text-danger">Sim</span></a></p>
      </div>
      </li>										
      </ul>
		</li>
