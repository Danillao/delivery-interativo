...
<div class="main-container">
  ...
  <div class="accordion" id="accordionExample" style="margin-top: 55px; margin-bottom: 130px; overflow: hidden; height:100%; scrollbar-width: thin; z-index: 100">
              ...
              <div class="col-7">
                <div class="group">
                  <select class="input" name="bairro" id="bairro" required style="background: transparent;" onchange="calcularFrete()">
                    ...
                    <?php
                    $query = $pdo->query("SELECT * FROM tb_bairros ORDER BY id asc");
                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                    $total_reg = @count($res);
                    if ($total_reg > 0) {
                      for ($i = 0; $i < $total_reg; $i++) {
    ...
    <div class="accordion-item">
      <h2 class="accordion-header" id="heading4">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4" id="colapse-4">
          4 - PAGAMENTO
        </button>
      </h2>
      ...
      <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#accordionExample">
        <div class="accordion-body">
          ...
          <div class="row">
            ...
            <div class="col-3 form-check check_responsive">
              <small>Dinheiro
          ...
          <div id="pagar_pix" style="margin-top: 15px">
            ...
            Chave <?php echo $tipo_chave ?> : <span><?php echo $chave_pix ?></span> <br>
          ...
          <div id="pagar_dinheiro" style="margin-top: 15px">
            <b class="titulo_responsive">Dinheiro na Entrega</b>
  ...
  function finalizarPedido() {
    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        //   //a.target= '_blank';
        //   a.href = 'http://api.whatsapp.com/send?1=pt_BR&phone=&text= *Novo Pedido*  %0A Hora: *' + hora + '* %0A Total: R$ *' + total_compra_finalF + '* %0A Entrega: *' + entrega + '* %0A Pagamento: *' + pagamento + '* %0A Cliente: ** %0A Previsão de Entrega: *' + result + '*';
        //   a.click();
        //}
